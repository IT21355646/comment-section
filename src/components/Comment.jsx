...
const Comment = ({ comment }) => {
  ...
  const [isDeleted, setIsDeleted] = useState(false); // Add state for deletion
  ...
  if (isDeleted) return null; // Hide comment if deleted
          ...
          <div className="flex justify-between items-center">
            ...
            {isCurrentUser ? (
                <div className="flex space-x-4">
                    ...
                    <button className="text-indigo-600 font-bold hover:text-indigo-400 flex items-center space-x-1">
                      {/* Edit icon */}
